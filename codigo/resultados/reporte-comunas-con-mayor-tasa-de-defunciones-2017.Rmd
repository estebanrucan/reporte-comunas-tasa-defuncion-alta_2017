...
En Chile, gracias a los datos otorgados por el DEIS y el censo, es posible realizar un estudio de las tasas de defunciones presentes en las comunas de Chile para el año 2017. El fin de esto es encontrar patrones dentro de las regiones y así iniciar campañas de prevención donde sea necesario. Se realizó un estudio analítico de las defunciones en cada comuna y se encontraron altas tasas de defunciones en la Zona Sur del país, por lo que es necesario iniciar campañas de prevención donde fue mencionado.
...
Al combinar estas bases de datos, se utilizaron estadísticos como la tasa de mortalidad (o tasa de defunción), esta consiste en establecer una esperanza de muertes cada 100.000 habitantes de la zona en estudio. Se decidió que la tasa de mortalidad de una comuna es alta, cuando la tasa de mortalidad supera al tercer cuantil de la región a la que pertenece o cuando la tasa supera un valor de 800.

A continuación, para realizar el estudio comuna a comuna, se consideró mostrar dos tablas, una que muestre información sobre las categorías de enfermedades que más provocaron defunciones, esto es, a que grupo de enfermedades pertence cada enfermedad. Y posteriormente, una tabla que indique las enfermedades específicas que provocaron las mayores cantidades de defunciones en cada comuna. Ambas tablas contienen la cantidad de defunciones de cada categoría o enfermedad respectivamente en conjunto a la edad media.
...
Continuando el estudio, se enseñaran las categorías de enfermedades que más causaron defunciones en Curepto, junto a la cantidad de estas y la edad media respectiva. Para ello veamos la siguiente tabla. 
