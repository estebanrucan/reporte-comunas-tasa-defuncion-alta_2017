...
En el momento de hacer el análisis región a región se consideraron las regiones donde se vio una mayor tasa de mortalidad durante el estudio. Para cada región se exhibirá una visualización general, una visualización específica de las comunas de la región con mayor tasa de mortalidad, junto con una tabla con los mimos datos del punto anterior, adicionando información sobre la población. 
...
Se consideraron cinco regiones donde se pueden apreciar las comunas con tasa de defunción más alta, para comenzar se presentará a la región del Maule.
