...
write.csv(data_frame, file = 'D:\\LET0010\\reporte_infarto_miocardio_1990-2017\\data_frame\\procesados\\base_limpia.csv')
...
write.csv(data_frame_im, file = 'D:\\LET0010\\reporte_infarto_miocardio_1990-2017\\data_frame\\procesados\\base-filtrada.csv')
```
...
```{r DEFUNCIONES IMC POR REGION}

data_frame_im %>% 
  group_by(GLOSA_REG_RES) %>%
  summarise(Defunciones = length(GLOSA_REG_RES)) %>%
